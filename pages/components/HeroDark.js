        ...
        <div className="h-11/12">
            ...
            <div className="relative z-10 w-full h-[95vh] flex flex-col justify-center">
                ...
                <div className="w-full justify-center flex">
                    ...
                    <a href="https://github.com/HITK-2025/first-contribution" target="_blank" rel="noreferrer">
                ...
                <div className="flex justify-center pt-[20vh]">
                    <div className="animate-bounce bg-none p-2 w-10 h-10 ring-1 ring-slate-900/5 dark:ring-slate-200/20 shadow-lg rounded-full flex items-center justify-center">
                        <svg className="w-6 h-6 textblack" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="white">
                            <path d="M19 14l-7 7m0 0l-7-7m7 7V3"></path>
                        </svg>
                    </div>
                </div>
                <h1 className=" animate-bounce pt-[5vh] text-center text-5xw font-sans font-bold text-[#f7e2e2]    opacity-90">Scroll Down</h1>
            </div>
        </div>
  );
};
