            ...
            <div className="flex flex-wrap -m-4">
              <div className="lg:w-1/4 lg:mb-0 mb-6 p-4">
                ...
                <div className="flex justify-center">
                  ...
                  <a
                    href="https://www.linkedin.com/in/roshan-kumar-176918202/"
                    target="_blank"
                  >
              ...
              <div className="lg:w-1/4 lg:mb-0 mb-6 p-4">
                <div className="h-full text-center">
                  ...
                  <p className="leading-relaxed">
                    SDE Intern @DocuComb | 🇮🇳 Microsoft Imagine Cup India
                    Finalist '22 l Campus Tech Leader @iNeuron.ai 🔰 | Full
                    stack Web Developer 📌| AWS ✨ | Learning DevOps⚡| Building
                    @Clueless 🚀 | Loves to Play Chess | Reach me at
                    rajdipgupta019@gmail.com
                  </p>
                  <span className="inline-block h-1 w-10 rounded bg-blue-500 mt-6 "></span>
                </div>
                <div className="flex justify-center">
                  <a
                    href="https://github.com/Rajdip019/Rajdip019"
                    target="_blank"
                  >
                    <div className=" cursor-pointer hover:scale-105 transition-all mr-3">
                      <svg
                  ...
                  <a
                    href="https://www.linkedin.com/in/rajdeep-sengupta/"
                    target="_blank"
                  >
                    <div className=" cursor-pointer hover:scale-105 transition-all">
                      <svg
              ...
              <div className="lg:w-1/4 lg:mb-0 p-4">
                <div className="h-full text-center">
                  ...
                  <p className="leading-relaxed">
                    Hello there! I'm Nikhil Currently | Into Machine Learning |
                    Backend Development | Python | Django | Open Source🚀 |
                ...
                <div className="flex justify-center">
                  ...
                  <a
                    href="https://www.linkedin.com/in/nikhil-raj-117246232/"
                    target="_blank"
                  >
                    <div className=" cursor-pointer hover:scale-105 transition-all">
                      <svg
              ...
              <div className="lg:w-1/4 lg:mb-0 p-4 mt-8 lg:mt-0">
                <div className="h-full text-center">
                  ...
                  <p className="leading-relaxed">
                    Intern @Docucomb | Microsoft Imagine Cup India Finalist '22
                    l GDSC HITK Core Team Member | Full stack Web & Mobile
                    Developer | Exploring Flutter | Reach me at:
                    debajyotisaha14@gmail.com
                  </p>
                  <span className="inline-block h-1 w-10 rounded bg-blue-500 mt-6 "></span>
                </div>
                <div className="flex justify-center">
