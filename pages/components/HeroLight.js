...
const HeroLight = () => {
  return (
    <div className="h-11/12">
      ...
      <h1 className="text-center text-5xl font-sans font-bold text-blue-600 opacity-90">Learn. Grow.</h1>
      <h1 className="text-center text-7xl font-sans mt-8 font-bold text-blue-600 opacity-90 ">Coding Club</h1>
